...
/* External objects */
extern vision_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
vision_void printScannerError(vision_char* fmt, ...);
vision_void displayScanner(BufferReader* ptrBuffer);
vision_long getScannerFilesize(vision_char* fname);
